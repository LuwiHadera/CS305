...
const myFunctions = require ("./arrays");  //with node need the name of your file with your functions here
const maxOfThree = myFunctions.maxOfThree;  //do this for all of the functions used in the Mocha tests
const multiply = myFunctions.multiply;
const sum = myFunctions.sum;
const findLongestWord = myFunctions.longestWord
const reverseArray = myFunctions.reverseArray
const scoreExams = myFunctions.scoreExam
const reverseArrayInPlace = myFunctions.reverseArrayInPlace
